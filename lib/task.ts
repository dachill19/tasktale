    ...
    try {
        ...
        switch (filter) {
            ...
            case "today":
                ...
                query = query
                    .gte("deadline", startOfDay.toLocaleDateString())
                    .lte("deadline", endOfDay.toLocaleDateString());
                break;
        }
...
export const updateTaskStatus = (taskId: string, completed: boolean) =>
    updateRecord("tasks", taskId, { completed }, "Updating task status");

export const updateSubTaskStatus = (subTaskId: string, completed: boolean) =>
    updateRecord(
        "sub_tasks",
        subTaskId,
        { completed },
        "Updating sub-task status"
    );
...
export const deleteTask = async (
    ...
    try {
        // First delete sub-tasks (if cascade is not enabled)
