        ...
        return (
            ...
            >
                ...
                <Text color="$gray6" textAlign="center" fontSize="$3">
                    Mulai dengan menambahkan beberapa tugas dan jurnal untuk
                    melihat analytics
                </Text>
                <XStack
                    bg="$blue4"
            ...
            >
                ...
                {loadingProductivity ? (
                    ...
                    <ProductivityCard
                        ...
                        icon="⏰"
                        data={{
                            labels: productivityData.map(
                                (item) => `${item.hour}:00`
                            ),
                            datasets: [
                                {
                                    data: productivityData.map(
