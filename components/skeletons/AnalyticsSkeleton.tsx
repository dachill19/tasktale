      ...
      {Array.from({ length: 4 }).map((_, index) => (
        <YStack key={index} gap="$2" marginBottom="$2">
          ...
          <XStack alignItems="center" gap="$2">
            <Skeleton width={60} height={28} radius={4} colorMode="light" />
...
export const ChartCardSkeleton = ({ titleWidth = 180 }: { titleWidth?: number }) => (
  <SkeletonCard>
    <YStack gap="$2">
      {/* Title */}
      <Skeleton width={titleWidth} height={16} radius={4} colorMode="light" />
      {/* Chart */}
      <YStack alignItems="center" marginVertical="$2">
        <Skeleton width="90%" height={200} radius={12} colorMode="light" />
      </YStack>
      {/* Legend */}
  ...
  <SkeletonCard>
    <YStack gap="$2">
      ...
      <YStack alignItems="center" justifyContent="center">
        <Skeleton width={150} height={150} radius="round" colorMode="light" />
      </YStack>
      {/* Legend Items */}
