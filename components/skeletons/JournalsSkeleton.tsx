  ...
  <YStack position="relative" marginBottom="$3">
    <SkeletonCard>
      ...
      <YStack space="$2" marginBottom="$3">
        ...
        <Skeleton width="60%" height={14} radius={4} colorMode="light" />
      </YStack>

      {/* Journal Images (Single image placeholder for simplicity) */}
      <YStack marginBottom="$3">
        <Skeleton width="100%" height={150} radius={8} colorMode="light" />
      </YStack>

      {/* Journal Tags */}
      <XStack space="$2" alignItems="center" flexWrap="wrap">
        <Skeleton width={70} height={24} radius={12} colorMode="light" />
        <Skeleton width={90} height={24} radius={12} colorMode="light" />
